...
@Table(name = "users")
public class User {
    // NOTE (antipattern demo): password is owned by auth-service.
    // @Transient prevents Hibernate from mapping this field to a DB column,
    // allowing schema validation to pass without the password column here.
